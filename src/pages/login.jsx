...
const Login = () => {
  ...
  return (
    <div className="w-full min-h-screen h-screen flex items-center justify-center bg-gradient-to-tr from-blue-950 via-black to-indigo-900 relative overflow-hidden font-poppins">
      {/* Animated Particles */}
      <Particles
        id="tsparticles"
